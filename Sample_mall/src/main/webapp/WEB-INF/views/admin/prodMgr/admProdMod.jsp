...
<form action="prodMod" method="post" onsubmit="return chkSubmit()" onreset="return chkReset()" name="frm" enctype="multipart/form-data">
<div class="container">
	<div class="row">
						...
						<div class="col-md-12 col-lg-12 ">
							<table class="table table-user-information">
								<tbody>
									<tr>
										<td>상품번호:</td>
										<td><input class="form-control" type="text" name="p_no" value="${vo.p_no}"></td>
									</tr>
									<tr>
										<td>상품명 : </td>
										<td><input class="form-control" type="text" name="p_name" value="${vo.p_name}"></td>
									</tr>
									<tr>
										<td>상품가격 : </td>
									...
									<tr>
										<td>상품정보 : </td>
										<td><textarea class="form-control" rows="20" name="p_info">${vo.p_info}</textarea></td>
									</tr>
								</tbody>
							</table>
							<div>
